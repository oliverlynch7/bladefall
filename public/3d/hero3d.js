...
import {syncNpcs} from './npc3d.js?v=2008';
import {syncProjectiles} from './projectile3d.js?v=1981s';
import {syncCompanions} from './companion3d.js?v=2007';
/* ─────────────────────────────────────────────────────────────────────────────
...
import { WORLD3D, syncWorld } from './world3d.js?v=2008';
import { MOB3D, syncMobs, mobDrawn } from './mob3d.js?v=2007';
import { PROP3D, syncProps } from './prop3d.js?v=2007';
...
export function drawHero3D(p, t){
  ...
  syncProjectiles(scene);
    ...
    renderer.shadowMap.enabled=!!(window.__OUTSKIRTS_ACTIVE||window.__HUB_ART_ACTIVE||window.__HOLLOW_ART_ACTIVE||window.__KEEP_ART_ACTIVE||window.__FROST_ART_ACTIVE||window.__DEEP_ART_ACTIVE) && WORLD3D.on && window.__BF_META?.().quality!=='low';
    ...
    if(window.__DEEP_SHADOW_DIRTY){renderer.shadowMap.needsUpdate=true;window.__DEEP_SHADOW_DIRTY=false;}
    if(window.__FROST_SHADOW_DIRTY){renderer.shadowMap.needsUpdate=true;window.__FROST_SHADOW_DIRTY=false;}
