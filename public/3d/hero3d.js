...
import { WORLD3D, syncWorld } from './world3d.js?v=1961';
...
export function drawHero3D(p, t){
  ...
  try {
    ...
    renderer.shadowMap.enabled=!!(window.__OUTSKIRTS_ACTIVE||window.__HUB_ART_ACTIVE||window.__HOLLOW_ART_ACTIVE||window.__KEEP_ART_ACTIVE) && WORLD3D.on && window.__BF_META?.().quality!=='low';
