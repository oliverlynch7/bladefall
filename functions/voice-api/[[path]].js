import returns from '../../public/3d/story/return-visits.json';
import finale from '../../public/3d/story/final-king.json';
import ascent from '../../public/3d/story/long-ascent.json';
...
import thunder from '../../public/3d/story/thunder-cliffs.json';
...
export async function handle(request,env){
 ...
 if(!env.VOICE_BUCKET)return json({error:'Voice Studio storage is not configured yet.'},503);
