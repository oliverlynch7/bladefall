...
U111 latest finale direction: approved orb question is "How can we stop the Abyss King?" Give location, soul vision and importance of defeating his linked soul, but NO final-cut/Ian/Blade or portal-collapse spoilers. At defeat the portal is overwhelmed by the combined powers involving player and King and both fall into it. Do not depict the physical collapse solely as an abstract anchor failure. Control ends with King defeat; actual restoration still requires the surprising final cut. Older fixed-question and collapse phrasing below is superseded by this note.

U110 final story decisions supersede older alternatives below: Ellis has just been captured in his secret laboratory inside the ice caves; rescue precedes transport to be Hollowed. The conscious Sunspire orb supplies the visual glimpse of trapped souls, replacing the viewing-frame proposal. It identifies the linked soul as the necessary target; dialogue must reconcile this with established final-cut release (King death disables anchor, cut completes rescue). Ian's Blade is only rendered/used in the interactive ending cutscene, never equipped in gameplay or granted to inventory. Do not invent a spiritual replica or equipment restoration step.
