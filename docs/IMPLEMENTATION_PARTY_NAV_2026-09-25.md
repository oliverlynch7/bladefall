...
Production receipt: f30ea4c deployed to main. Live read-only browser confirms 2.037.0-party-navigation, HERO3D ready, navigation resolver and teleport runtime loaded. Private source archive contains 196 messages, zero unparsed lines, valid source references.
