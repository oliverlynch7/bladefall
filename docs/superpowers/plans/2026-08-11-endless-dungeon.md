...
The grid grows with depth on purpose (GX 6→9, GZ 5→8, plus `TSCALE` 1.2) and the table above shows
it working: floor 20 is 13 rooms and 2942 units against floor 1's 10 and 2175. **An autopilot run
